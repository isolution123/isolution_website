...
<title>Clientele | I - Solutions - Wealth Advisory</title>
...
<meta property="og:image" content="images/logo-white.gif">
...
<meta name="twitter:image" content="images/logo-white.gif">
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <img src="images/chart1.png" class="custom-img-responsive">
        </div>
        <div class="col-md-6 col-sm-6">
          <img src="images/chart2.png" class="custom-img-responsive">
        </div>        
    </div>
</div>
</section>

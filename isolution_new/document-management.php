...
<title>Document Management System In Wealth Management | I-Solutions</title>
<meta name="author" content="">
<meta name="description" content="I-Solutions provide the best document management system and protect your document, get access to your personal document anywhere.">
...
<header class="int-header">
  ...
  <div class="table">
    <div class="table-cell">
      <div class="container">
        <h3>Document Management<span>.</span></h3>
      </div>
      <!-- end container --> 
    </div>
    <!-- end table-cell --> 
...
<section class="new-section-padding featured-solutions transition">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h2 class="p-margin text-center">Document Management</h2>
        <h3 class="text-center">Get access to your document from anywhere</h3><br>
        <p>Have you any time missed on locating your personal documents? </p>      

        <p>When your secretary is on leave and you need your personal documents, Do you postpone your important works? </p>

        <p>You need to look at your last year income papers, but your Chartered Accountant is out of town?</p>

        <p>You need your passport copies or PAN Card seating out of town or overseas? </p>

        <h6>We at I-Solutions gives you unique service to safe guard copies of your important documents and make them easily available to you when you need.</h6>
      </div>                            
    </div>
  </div>
</section>

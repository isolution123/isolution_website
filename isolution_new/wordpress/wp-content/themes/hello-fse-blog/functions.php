 ...
 * @return array
 */
function hello_fse_blog_add_default_mode_body_class( array $classes ): array {
	$global_settings = wp_get_global_settings();
	
	$theme_mode       = $global_settings['custom']['mode'] ?? [];
	$classes[]       = $theme_mode;
	
	return $classes;
}
add_filter( 'body_class', 'hello_fse_blog_add_default_mode_body_class' );

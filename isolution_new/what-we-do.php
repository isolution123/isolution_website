...
<title>What We Do | Best Wealth Advisory Services By I-Solutions</title>
<meta name="author" content="">
<meta name="description" content="I-Solutions offers many wealth advisory services such as life & health insurance, mutual funds, fixed deposit, equity, commodity, real estate, PMS & aif, Hni wealth management solutions. ">
  ...
  <div class="container">
    <div class="row text-center">
      <div class="col-xs-12 text-center">
        <h2 class="p-margin">What We Do</h2>
        <p class="new-f-size">We at I-Solutions bring you whole range of wealth advisory Services at your door step.</p>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12 grid-margin-desktp">
        <div class="solution-box">
          <figure class="image"><img class="we-do-icon" src="images/we-do/life-insurance.png" alt="Image"></figure>
          <h4 class="remove-line popins">Life & Health Insurance</h4>          
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12 grid-margin-desktp">
        <div class="solution-box">
          <figure class="image"><img class="we-do-icon" src="images/we-do/mutual-funds.png" alt="Image"></figure>
          <h4 class="remove-line popins">Mutual Funds</h4>          
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12 grid-margin-desktp">
        <div class="solution-box">
          <figure class="image"><img class="we-do-icon" src="images/we-do/fixed-deposit.png" alt="Image"></figure>
          <h4 class="remove-line popins">Fixed Deposit</h4>          
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12 grid-margin-desktp">
        <div class="solution-box">
          <figure class="image"><img class="we-do-icon" src="images/we-do/equity.png" alt="Image"></figure>
          <h4 class="remove-line popins">Equity</h4>          
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12 grid-margin-desktp">
        <div class="solution-box">
          <figure class="image"><img class="we-do-icon" src="images/we-do/commodity.png" alt="Image"></figure>
          <h4 class="remove-line popins">Commodity</h4>          
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12 grid-margin-desktp">
        <div class="solution-box">
          <figure class="image"><img class="we-do-icon" src="images/we-do/real-estate.png" alt="Image"></figure>
          <h4 class="remove-line popins">Real Estate</h4>          
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12 grid-margin-desktp">
        <div class="solution-box">
          <figure class="image"><img class="we-do-icon" src="images/we-do/pms.png" alt="Image"></figure>
          <h4 class="remove-line popins">PMS & AIF</h4>          
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12 grid-margin-desktp">
        <div class="solution-box">
          <figure class="image"><img class="we-do-icon" src="images/we-do/hni.png" alt="Image"></figure>

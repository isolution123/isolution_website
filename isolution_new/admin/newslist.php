  ...
  <div class="">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>News List</h2>
          <a href="<?php echo getPageUrl('addNews') ?>" class="btn btn-primary pull-right">Add News</a>
            ...
            <tbody>
              ...
              <?php foreach ($Customers as $Customer) : $Customer=(array)$Customer; ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="index.php?page=addNews&id=<?php echo $Customer['id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>

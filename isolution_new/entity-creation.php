...
<title>Entity Creation | I - Solutions - Wealth Advisory</title>
...
<header class="int-header">
  ...
  <div class="table">
    <div class="table-cell">
      <div class="container">
        <h3>Entity Creation<span>.</span></h3>
      </div>
      <!-- end container --> 
    </div>
    <!-- end table-cell --> 
    ...
    <div class="row">
      <div class="col-xs-12">
        <ul class="breadcrumb">
          ...
          <li class="active">Entity Creation</li>
        </ul>
      </div>
      <!-- end col-12 --> 
    </div>
...
<section class="new-section-padding featured-solutions transition">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h2 class="p-margin text-center">Entity Creation</h2>
        <h3 class="text-center">Protect your financial future</h3><br>
        <p>In any identity set-up process, the process of selecting the form of identity plays a very important role, as various factors like objective ,flexibility, requirement, taxation etc are required to be kept in mind and a wrong decision may hamper your future plan.</p>      

        <p>At I-Solutions we understand that it is not easy to select the right kind of identity form and therefore we can help you in understanding the technicalities that lies behind each form , to enable you to take a right and informed decision.</p>

        <p>Our networking with a leading trust and corporate service provider in India, gives you access to expert trust & other identity creation and management services, as well as helps you to organize your business throughout the world and create a trust that helps you organize your worldwide assets and manage your estate and tax efficiently.</p>

        <p>We can help you in setting the following form of identity:</p>
        <ul>
          <li>Non-Banking Finance Company</li>
          <li>Holding Companies</li>
          <li>Private Trust</li>
          <li>Charity Trust</li>
          <li>Offshore Trust</li>

...
<title>Best Estate Planning Service By I-Solutions | Wealth Management</title>
<meta name="author" content="">
<meta name="description" content="I –Solutions provide the five-level services of estate planning like estate plan advisory, preparation of wills, trust formation, trust management, client associates as executors.">
...
<header class="int-header">
  ...
  <div class="table">
    <div class="table-cell">
      <div class="container">
        <h3>Estate Planning<span>.</span></h3>
      </div>
      <!-- end container --> 
    </div>
    <!-- end table-cell --> 
...
<section class="new-section-padding featured-solutions transition">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h2 class="p-margin text-center">Estate Planning</h2>
        <h3 class="text-center">We can make living by what we get,<br> but we can make life by what we give.</h3><br>
        <p>We are all concerned with building wealth for ourselves and our family. We cannot control when we die, but we can ensure that the lives of those who remain after we are gone are as simple and smooth as possible. It is meant to protect the financial security of dependents and family members.</p>      

        <p>Estate Planning Services ensure the management of your wealth during and beyond your lifetime and plan your legacy.</p>

        <p>Following are the levels of our services:</p>
        <ul>
          <li>Estate Plan Advisory</li>
          <li>Preparation of Wills</li>
          <li>Trust Formation</li>
          <li>Trust Management</li>
          <li>Client Associates as executors</li>
        </ul>
      </div>                            
    </div>
  </div>
